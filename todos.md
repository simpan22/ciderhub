...
# Feature: Units (Status: Spec ready for review — docs/specs/units.md)
...
# Feature: Easier input forms (Status: Spec ready for review — docs/specs/streamlined-event-forms.md)
...
# Bug: American -> European date format and other date form fixes (Status: Spec ready for review — docs/specs/european-date-format.md; needs a decision, see spec)
...
# Feature: Mark batches as failed (Status: Spec ready for review — docs/specs/batch-failure.md)
Sometimes a batch fails, this can be because bacteria or other reasons.

# Feature: Tasting event (Status: Spec ready for review — docs/specs/tasting-event.md)
...
# Feature: Batch statistics (Status: Spec ready for review — docs/specs/batch-statistics.md; largest/most open-ended item, see spec)
...
# Bug: Batch start date (Status: Spec ready for review — docs/specs/batch-start-date.md)
